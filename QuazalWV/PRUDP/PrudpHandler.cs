...
namespace QuazalWV
{
    ...
    {
        public static List<ulong> timeToIgnore = [];
        private static readonly ExpiringLockManager<IPAddress> lockManager = new(expiration: TimeSpan.FromSeconds(20), cleanupInterval: TimeSpan.FromSeconds(10));
        ...
        public static PrudpPacket ProcessSYN(PrudpPacket p, IPEndPoint ep, out ClientInfo client)
        {
            ...
            return new()
            {
                ...
                flags = [PrudpPacket.PACKETFLAG.FLAG_ACK],
