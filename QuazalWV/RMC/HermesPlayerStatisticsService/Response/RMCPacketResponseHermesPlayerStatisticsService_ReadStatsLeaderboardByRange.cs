...
namespace QuazalWV
{
	public class RMCPacketResponseHermesPlayerStatisticsService_ReadStatsLeaderboardByRange : RMCPResponse
	{
		public List<PlayerStatContainer> Containers { get; set; }
		public uint UnkInt { get; set; }

		public RMCPacketResponseHermesPlayerStatisticsService_ReadStatsLeaderboardByRange()
		{
		...
		{
			return "[ReadStatsLeaderboardByRange Response]";
		}
	}
}
